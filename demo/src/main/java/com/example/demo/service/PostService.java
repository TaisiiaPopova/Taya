...
public class PostService {
    ...
    private final Converter<Post, com.example.demo.repository.model.Post> converter;
    private final UserService userService;

    public PostService(PostRepository postRepository, Converter<Post, com.example.demo.repository.model.Post> converter, UserService userService) {
